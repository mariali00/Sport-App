...
QT_MOC_LITERAL(3, 37, 21) // "on_pushButton_clicked"
    ...
    "MainWindow4\0on_pushButton_2_clicked\0"
...
void MainWindow4::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MainWindow4 *_t = static_cast<MainWindow4 *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject MainWindow4::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MainWindow4.data,
      qt_meta_data_MainWindow4,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MainWindow4::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MainWindow4.stringdata0))
        return static_cast<void*>(const_cast< MainWindow4*>(this));
